...
int main(int argc, char** argv)
{
    ...
    glimac::Program  program = loadProgram(applicationPath.dirPath() + "TP5/shaders/mandelbrot.vs.glsl", applicationPath.dirPath() + "TP5/shaders/mandelbrot.fs.glsl");
    program.use();
    ...
    GLfloat vertices[] = {
        -1.0f, -1.0f, 1.f, 1.f, 1.f, // premier sommet
        1.0f, -1.0f, 1.f, 1.f, 1.f,  // deuxième sommet
        -1.0f, 1.0f, 1.f, 1.f, 1.f,  // troisième sommet
        1.0f, 1.0f, 1.f, 1.f, 1.f    // quatrième sommet
    };
    ...
    const GLuint VERTEX_ATTR_POSITION = 0; // Activer l'attribut position, c'est à dire l'index 3 à cause du vertex shader
    glEnableVertexAttribArray(VERTEX_ATTR_POSITION);
    const GLuint VERTEX_ATTR_COULEUR = 1; // Activer l'attribut couleur, c'est à dire l'index 8 à cause du vertex shader
